...
> **Security:** Do not paste `1ck_`, `ocv_`, or Alchemy keys into chat. `curl | bash` runs a public script—review [install/install.sh](https://github.com/agentic-pantheon/aurey-mcp/blob/main/install/install.sh) or install manually below.
